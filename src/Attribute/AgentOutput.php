 ...
 * - Completion-only: set completionOnly when compact success can omit data.
 */
...
final class AgentOutput
{
     ...
     * @param bool                      $completionOnly Whether compact success may omit data
     */
    public function __construct(
        public readonly ?string $responseClass = null,
        public readonly array $properties = [],
        public readonly ?string $description = null,
        public readonly bool $completionOnly = false,
    ) {
    }
}
