...
```bash
curl -L https://github.com/Studapart/stud-cli/releases/download/v3.9.2/stud-3.9.2.phar -o ~/.local/bin/stud
...
```bash
sudo curl -L https://github.com/Studapart/stud-cli/releases/download/v3.9.2/stud-3.9.2.phar -o /usr/local/bin/stud
