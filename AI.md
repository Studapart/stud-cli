...
3.  **Documentation Updates**:
    ...
    - When command signatures, options, aliases, or agent JSON shapes change, run `stud docs:generate` and ensure `stud docs:check` passes.
    - Update curated docs when behavior affects workflows (`documentation/features/`, playbook) per `documentation/development/docs-playbook-update-prompt.md`.
