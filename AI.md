...
The development process is structured into four distinct phases, each with specific deliverables and quality gates. You **MUST** complete all phases in order before proceeding to the next and for each task you are given by the user.
